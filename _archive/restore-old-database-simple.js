...
async function restoreOldDatabaseSimple() {
  log('🚀 Restoring Old Database with Complete Data', 'step');
...
async function restoreDeviceModels() {
  ...
  const deviceModels = [
    // Apple Mobile
    { name: 'iphone 15 pro max', display_name: 'iPhone 15 Pro Max', brand_id: 1, device_type_id: 1, is_active: true, is_featured: true, sort_order: 0 },
    { name: 'iphone 15 pro', display_name: 'iPhone 15 Pro', brand_id: 1, device_type_id: 1, is_active: true, is_featured: true, sort_order: 1 },
    { name: 'iphone 15', display_name: 'iPhone 15', brand_id: 1, device_type_id: 1, is_active: true, is_featured: true, sort_order: 2 },
    { name: 'iphone 14 pro max', display_name: 'iPhone 14 Pro Max', brand_id: 1, device_type_id: 1, is_active: true, sort_order: 3 },
    { name: 'iphone 14 pro', display_name: 'iPhone 14 Pro', brand_id: 1, device_type_id: 1, is_active: true, sort_order: 4 },
    { name: 'iphone 14', display_name: 'iPhone 14', brand_id: 1, device_type_id: 1, is_active: true, sort_order: 5 },
    { name: 'iphone 13 pro max', display_name: 'iPhone 13 Pro Max', brand_id: 1, device_type_id: 1, is_active: true, sort_order: 6 },
    { name: 'iphone 13 pro', display_name: 'iPhone 13 Pro', brand_id: 1, device_type_id: 1, is_active: true, sort_order: 7 },
    { name: 'iphone 13', display_name: 'iPhone 13', brand_id: 1, device_type_id: 1, is_active: true, sort_order: 8 },
    { name: 'iphone 12 pro max', display_name: 'iPhone 12 Pro Max', brand_id: 1, device_type_id: 1, is_active: true, sort_order: 9 },
    { name: 'iphone 12 pro', display_name: 'iPhone 12 Pro', brand_id: 1, device_type_id: 1, is_active: true, sort_order: 10 },
    { name: 'iphone 12', display_name: 'iPhone 12', brand_id: 1, device_type_id: 1, is_active: true, sort_order: 11 },
    { name: 'iphone 11 pro max', display_name: 'iPhone 11 Pro Max', brand_id: 1, device_type_id: 1, is_active: true, sort_order: 12 },
    { name: 'iphone 11 pro', display_name: 'iPhone 11 Pro', brand_id: 1, device_type_id: 1, is_active: true, sort_order: 13 },
    { name: 'iphone 11', display_name: 'iPhone 11', brand_id: 1, device_type_id: 1, is_active: true, sort_order: 14 },
    { name: 'iphone se', display_name: 'iPhone SE', brand_id: 1, device_type_id: 1, is_active: true, sort_order: 15 },
    
    // Samsung Mobile
    { name: 'galaxy s24 ultra', display_name: 'Galaxy S24 Ultra', brand_id: 2, device_type_id: 1, is_active: true, is_featured: true, sort_order: 0 },
    { name: 'galaxy s24 plus', display_name: 'Galaxy S24+', brand_id: 2, device_type_id: 1, is_active: true, is_featured: true, sort_order: 1 },
    { name: 'galaxy s24', display_name: 'Galaxy S24', brand_id: 2, device_type_id: 1, is_active: true, is_featured: true, sort_order: 2 },
    { name: 'galaxy s23 ultra', display_name: 'Galaxy S23 Ultra', brand_id: 2, device_type_id: 1, is_active: true, sort_order: 3 },
    { name: 'galaxy s23 plus', display_name: 'Galaxy S23+', brand_id: 2, device_type_id: 1, is_active: true, sort_order: 4 },
    { name: 'galaxy s23', display_name: 'Galaxy S23', brand_id: 2, device_type_id: 1, is_active: true, sort_order: 5 },
    { name: 'galaxy s22 ultra', display_name: 'Galaxy S22 Ultra', brand_id: 2, device_type_id: 1, is_active: true, sort_order: 6 },
    { name: 'galaxy s22 plus', display_name: 'Galaxy S22+', brand_id: 2, device_type_id: 1, is_active: true, sort_order: 7 },
    { name: 'galaxy s22', display_name: 'Galaxy S22', brand_id: 2, device_type_id: 1, is_active: true, sort_order: 8 },
    { name: 'galaxy s21 ultra', display_name: 'Galaxy S21 Ultra', brand_id: 2, device_type_id: 1, is_active: true, sort_order: 9 },
    { name: 'galaxy s21 plus', display_name: 'Galaxy S21+', brand_id: 2, device_type_id: 1, is_active: true, sort_order: 10 },
    { name: 'galaxy s21', display_name: 'Galaxy S21', brand_id: 2, device_type_id: 1, is_active: true, sort_order: 11 },
    { name: 'galaxy note 20 ultra', display_name: 'Galaxy Note 20 Ultra', brand_id: 2, device_type_id: 1, is_active: true, sort_order: 12 },
    { name: 'galaxy note 20', display_name: 'Galaxy Note 20', brand_id: 2, device_type_id: 1, is_active: true, sort_order: 13 },
    { name: 'galaxy z fold 5', display_name: 'Galaxy Z Fold 5', brand_id: 2, device_type_id: 1, is_active: true, sort_order: 14 },
    { name: 'galaxy z flip 5', display_name: 'Galaxy Z Flip 5', brand_id: 2, device_type_id: 1, is_active: true, sort_order: 15 },
    
    // Google Mobile
    { name: 'pixel 8 pro', display_name: 'Pixel 8 Pro', brand_id: 3, device_type_id: 1, is_active: true, is_featured: true, sort_order: 0 },
    { name: 'pixel 8', display_name: 'Pixel 8', brand_id: 3, device_type_id: 1, is_active: true, is_featured: true, sort_order: 1 },
    { name: 'pixel 7 pro', display_name: 'Pixel 7 Pro', brand_id: 3, device_type_id: 1, is_active: true, sort_order: 2 },
    { name: 'pixel 7', display_name: 'Pixel 7', brand_id: 3, device_type_id: 1, is_active: true, sort_order: 3 },
    { name: 'pixel 6 pro', display_name: 'Pixel 6 Pro', brand_id: 3, device_type_id: 1, is_active: true, sort_order: 4 },
    { name: 'pixel 6', display_name: 'Pixel 6', brand_id: 3, device_type_id: 1, is_active: true, sort_order: 5 },
    
    // Apple Laptop
    { name: 'macbook pro 16', display_name: 'MacBook Pro 16"', brand_id: 6, device_type_id: 2, is_active: true, is_featured: true, sort_order: 0 },
    { name: 'macbook pro 14', display_name: 'MacBook Pro 14"', brand_id: 6, device_type_id: 2, is_active: true, is_featured: true, sort_order: 1 },
    { name: 'macbook pro 13', display_name: 'MacBook Pro 13"', brand_id: 6, device_type_id: 2, is_active: true, sort_order: 2 },
    { name: 'macbook air 15', display_name: 'MacBook Air 15"', brand_id: 6, device_type_id: 2, is_active: true, is_featured: true, sort_order: 3 },
    { name: 'macbook air 13', display_name: 'MacBook Air 13"', brand_id: 6, device_type_id: 2, is_active: true, sort_order: 4 },
    { name: 'macbook', display_name: 'MacBook', brand_id: 6, device_type_id: 2, is_active: true, sort_order: 5 },
    
    // Dell Laptop
    { name: 'xps 13', display_name: 'XPS 13', brand_id: 7, device_type_id: 2, is_active: true, is_featured: true, sort_order: 0 },
    { name: 'xps 15', display_name: 'XPS 15', brand_id: 7, device_type_id: 2, is_active: true, is_featured: true, sort_order: 1 },
    { name: 'xps 17', display_name: 'XPS 17', brand_id: 7, device_type_id: 2, is_active: true, sort_order: 2 },
    { name: 'latitude 5520', display_name: 'Latitude 5520', brand_id: 7, device_type_id: 2, is_active: true, sort_order: 3 },
    { name: 'precision 5560', display_name: 'Precision 5560', brand_id: 7, device_type_id: 2, is_active: true, sort_order: 4 },
    
    // HP Laptop
    { name: 'spectre x360', display_name: 'Spectre x360', brand_id: 8, device_type_id: 2, is_active: true, is_featured: true, sort_order: 0 },
    { name: 'envy x360', display_name: 'Envy x360', brand_id: 8, device_type_id: 2, is_active: true, sort_order: 1 },
    { name: 'pavilion', display_name: 'Pavilion', brand_id: 8, device_type_id: 2, is_active: true, sort_order: 2 },
    { name: 'elitebook', display_name: 'EliteBook', brand_id: 8, device_type_id: 2, is_active: true, sort_order: 3 },
    
    // Apple Tablet
    { name: 'ipad pro 12.9', display_name: 'iPad Pro 12.9"', brand_id: 13, device_type_id: 3, is_active: true, is_featured: true, sort_order: 0 },
    { name: 'ipad pro 11', display_name: 'iPad Pro 11"', brand_id: 13, device_type_id: 3, is_active: true, is_featured: true, sort_order: 1 },
    { name: 'ipad air', display_name: 'iPad Air', brand_id: 13, device_type_id: 3, is_active: true, sort_order: 2 },
    { name: 'ipad', display_name: 'iPad', brand_id: 13, device_type_id: 3, is_active: true, sort_order: 3 },
    { name: 'ipad mini', display_name: 'iPad mini', brand_id: 13, device_type_id: 3, is_active: true, sort_order: 4 },
    
    // Samsung Tablet
    { name: 'galaxy tab s9 ultra', display_name: 'Galaxy Tab S9 Ultra', brand_id: 14, device_type_id: 3, is_active: true, is_featured: true, sort_order: 0 },
    { name: 'galaxy tab s9 plus', display_name: 'Galaxy Tab S9+', brand_id: 14, device_type_id: 3, is_active: true, is_featured: true, sort_order: 1 },
    { name: 'galaxy tab s9', display_name: 'Galaxy Tab S9', brand_id: 14, device_type_id: 3, is_active: true, sort_order: 2 },
    { name: 'galaxy tab s8 ultra', display_name: 'Galaxy Tab S8 Ultra', brand_id: 14, device_type_id: 3, is_active: true, sort_order: 3 },
    { name: 'galaxy tab s8 plus', display_name: 'Galaxy Tab S8+', brand_id: 14, device_type_id: 3, is_active: true, sort_order: 4 },
    { name: 'galaxy tab s8', display_name: 'Galaxy Tab S8', brand_id: 14, device_type_id: 3, is_active: true, sort_order: 5 }
  ];
...
async function restoreDynamicPricing() {
  ...
  const popularMobileModels = deviceModels.filter(m => m.device_type_id === 1 && m.is_featured);
  ...
  const popularLaptopModels = deviceModels.filter(m => m.device_type_id === 2 && m.is_featured);
  ...
  const popularTabletModels = deviceModels.filter(m => m.device_type_id === 3 && m.is_featured);
...
restoreOldDatabaseSimple().catch(console.error); 