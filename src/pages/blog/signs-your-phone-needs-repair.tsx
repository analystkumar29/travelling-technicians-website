              ...
              <div className="sticky top-24 space-y-8">
                <div className="card mb-8 p-6">
                  ...
                  <ul className="space-y-2 text-gray-700">
                    <li>
                      <Link href="/services/mobile-repair" className="hover:text-primary-600 transition-colors">Screen Replacement</Link>
                    </li>
                    <li>
                      <Link href="/services/mobile-repair" className="hover:text-primary-600 transition-colors">Battery Replacement</Link>
                    </li>
                    <li>
                      <Link href="/services/mobile-repair" className="hover:text-primary-600 transition-colors">Charging Port Repair</Link>
                    </li>
                    <li>
                      <Link href="/services/mobile-repair" className="hover:text-primary-600 transition-colors">Camera Repair</Link>
                    </li>
                    <li>
                      <Link href="/services/mobile-repair" className="hover:text-primary-600 transition-colors">Water Damage Repair</Link>
                    </li>
                  </ul>
                </div>
