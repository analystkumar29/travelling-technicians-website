...
export default function VancouverServiceArea() {
  const router = useRouter();

  useEffect(() => {
    // Redirect to the actual repair page after a brief delay for SEO
    const timer = setTimeout(() => {
      router.replace('/repair/vancouver');
    }, 100);
    ...
    <>
      ...
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="text-center max-w-md mx-auto p-6">
          ...
          <h1 className="text-2xl font-bold text-gray-800 mb-2">Mobile & Laptop Repair in Vancouver, BC</h1>
          <p className="text-gray-600 mb-4">
            Professional doorstep repair services for Vancouver residents. We come to you!
          </p>
          <p className="text-sm text-gray-500">Loading Vancouver repair services...</p>
        </div>
      </div>
    </>
  );
