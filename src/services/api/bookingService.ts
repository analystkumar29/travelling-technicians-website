 ...
 */
export async function checkServiceArea(postalCode: string): Promise<{
  city: string;
  serviceable: boolean;
  sameDay: boolean;
  travelFee?: number;
 ...
 */
export async function getAvailableTimeSlots(date: string, serviceType: string): Promise<string[]> {
 ...
 */
export async function createBooking(bookingData: CreateBookingRequest): Promise<BookingCreationResponse> {
 ...
 */
export async function getBookingByReference(reference: string): Promise<BookingData> {
