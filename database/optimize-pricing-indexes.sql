-- Dynamic Pricing Database Optimization Script
...
-- NOTE: Keeping dynamic_pricing_service_id_model_id_pricing_tier_id_key as it backs a UNIQUE constraint
-- This constraint prevents duplicate pricing entries (service+model+tier) which is essential for data integrity
...
SELECT 'Database optimization completed successfully! ✅' as status,
       'Removed unused indexes and added optimized composite indexes' as details; 