...
SELECT 
    b.id as brand_id,
    'redmi-note-13-5g' as name,
    'Redmi Note 13 5G' as display_name,
    2024 as model_year,
    '6.67"' as screen_size,
    ARRAY['128GB', '256GB'] as storage_options,
    ARRAY['Midnight Black', 'Ice Blue', 'Mint Green'] as color_options,
    true as is_featured,
    6 as sort_order
FROM brands b 
JOIN device_types dt ON b.device_type_id = dt.id 
...
SELECT 
    b.id as brand_id,
    'redmi-note-12-pro-plus-5g' as name,
    'Redmi Note 12 Pro+ 5G' as display_name,
    2023 as model_year,
    '6.67"' as screen_size,
    ARRAY['256GB', '512GB'] as storage_options,
    ARRAY['Iceberg Blue', 'Midnight Black', 'Sky Blue'] as color_options,
    false as is_featured,
    11 as sort_order
FROM brands b 
JOIN device_types dt ON b.device_type_id = dt.id 
...
SELECT 
    b.id as brand_id,
    'poco-f5' as name,
    'POCO F5' as display_name,
    2023 as model_year,
    '6.67"' as screen_size,
    ARRAY['256GB', '512GB'] as storage_options,
    ARRAY['Carbon Black', 'Snowstorm White', 'Electric Blue'] as color_options,
    false as is_featured,
    13 as sort_order
FROM brands b 
JOIN device_types dt ON b.device_type_id = dt.id 
...
SELECT 
    b.id as brand_id,
    'redmi-note-11-pro-plus-5g' as name,
    'Redmi Note 11 Pro+ 5G' as display_name,
    2022 as model_year,
    '6.67"' as screen_size,
    ARRAY['128GB', '256GB'] as storage_options,
    ARRAY['Graphite Gray', 'Polar White', 'Star Blue'] as color_options,
    false as is_featured,
    17 as sort_order
FROM brands b 
JOIN device_types dt ON b.device_type_id = dt.id 
...
SELECT 
    b.id as brand_id,
    'mi-11-pro' as name,
    'Mi 11 Pro' as display_name,
    2021 as model_year,
    '6.81"' as screen_size,
    ARRAY['128GB', '256GB', '512GB'] as storage_options,
    ARRAY['Midnight Gray', 'Celestial Silver', 'Enchanting Green'] as color_options,
    false as is_featured,
    20 as sort_order
FROM brands b 
JOIN device_types dt ON b.device_type_id = dt.id 
