...
SELECT 
    b.id as brand_id,
    'galaxy-book3-360-15' as name,
    'Galaxy Book3 360 15.6"' as display_name,
    2023 as model_year,
    '15.6"' as screen_size,
    ARRAY['256GB', '512GB'] as storage_options,
    ARRAY['Silver'] as color_options,
...
SELECT 
    b.id as brand_id,
    'galaxy-book3-360-13' as name,
    'Galaxy Book3 360 13.3"' as display_name,
    2023 as model_year,
    '13.3"' as screen_size,
    ARRAY['256GB', '512GB'] as storage_options,
    ARRAY['Silver'] as color_options,
...
SELECT 
    b.id as brand_id,
    'galaxy-book2-360-15' as name,
    'Galaxy Book2 360 15.6"' as display_name,
    2022 as model_year,
    '15.6"' as screen_size,
    ARRAY['256GB', '512GB'] as storage_options,
    ARRAY['Silver'] as color_options,
...
SELECT 
    b.id as brand_id,
    'galaxy-book2-360-13' as name,
    'Galaxy Book2 360 13.3"' as display_name,
    2022 as model_year,
    '13.3"' as screen_size,
    ARRAY['256GB', '512GB'] as storage_options,
    ARRAY['Silver'] as color_options,
...
-- Galaxy Book Pro 360 (2021)
INSERT INTO device_models (brand_id, name, display_name, model_year, screen_size, storage_options, color_options, is_featured, sort_order)
SELECT 
    b.id as brand_id,
    'galaxy-book-pro-360-15' as name,
    'Galaxy Book Pro 360 15.6"' as display_name,
    2021 as model_year,
    '15.6"' as screen_size,
    ARRAY['256GB', '512GB', '1TB'] as storage_options,
    ARRAY['Mystic Silver', 'Mystic Navy'] as color_options,
    false as is_featured,
    18 as sort_order
FROM brands b 
JOIN device_types dt ON b.device_type_id = dt.id 
...
SELECT 
    b.id as brand_id,
    'galaxy-book-pro-360-13' as name,
    'Galaxy Book Pro 360 13.3"' as display_name,
    2021 as model_year,
    '13.3"' as screen_size,
    ARRAY['256GB', '512GB', '1TB'] as storage_options,
    ARRAY['Mystic Silver', 'Mystic Navy'] as color_options,
