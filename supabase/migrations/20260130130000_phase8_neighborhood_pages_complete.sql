-- Phase 8: Complete Neighborhood Pages Implementation
-- Creates neighborhood_pages table with all schema, indexes, policies, and populates 31 neighborhoods
-- Combined migration for safe, atomic execution

-- ============================================================================
-- STEP 1: Create neighborhood_pages table
-- ============================================================================
...
DROP POLICY IF EXISTS "anyone_can_read_neighborhood_pages" ON neighborhood_pages;
DROP POLICY IF EXISTS "admin_can_write_neighborhood_pages" ON neighborhood_pages;
DROP POLICY IF EXISTS "admin_can_update_neighborhood_pages" ON neighborhood_pages;
DROP POLICY IF EXISTS "admin_can_delete_neighborhood_pages" ON neighborhood_pages;
...
-- ============================================================================
-- STEP 6: Populate 31 Neighborhoods with Proof-of-Life Data
-- ============================================================================
...
-- This query can be run separately to verify the data was populated
-- SELECT COUNT(*) as total_neighborhoods FROM neighborhood_pages;
-- SELECT city_id, COUNT(*) as count FROM neighborhood_pages GROUP BY city_id ORDER BY count DESC;
